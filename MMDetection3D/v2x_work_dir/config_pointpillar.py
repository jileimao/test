...
# [0, -39.68, -3, 92.16, 39.68, 1]
# point_cloud_range = [0, -34.56, -3, 69.12, 34.56, 1]
# point_cloud_range = [-34.56, -34.56, -3, 34.56, 34.56, 1]
z_center_car = -2.66
...
data_root = '/data/hdd01/aidata2/users/maojl/data/cooperative-vehicle-infrastructure/'
# data_root='/data/hdd01/aidata2/users/tangyingjuan/DAIR-V2X-Examples-cooperative-label2v/cooperative-vehicle-infrastructure/'
# work_dir='./work_dirs_test'
work_dir = './work_dirs_all_fusion_20epoch_5_18'

...
data_info_train_path='./dataset_jsons/flow_data_info_train_2.json'
data_info_val_path='./dataset_jsons/flow_data_info_val_2.json'
...
model = dict(
    ...
    train_cfg=dict(
        ...
        pos_weight=-1,
        debug=False,
        pretrained_model='../v2x_work_dir/checkpoints/epoch_80.pth',
        data_root=data_root
    ),
    test_cfg=dict(
        use_rotate_nms=True,

...
if __name__ == "__main__":
    ...
    inf_data_infos_path = os.path.join(data_root, 'infrastructure-side/data_info.json')
    inf_data_infos = read_json(inf_data_infos_path)
    inf_idx_batch_mappings = idx_batch_mapping(inf_data_infos)

    data_infos_path = os.path.join(data_root, 'cooperative/data_info_new_train.json')
    ...
    data_infos_path = os.path.join(data_root, 'cooperative/data_info_new_val.json')
    data_infos = read_json(data_infos_path)

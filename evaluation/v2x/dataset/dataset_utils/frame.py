...
if __name__ == "__main__":
    ...
    transformer = Coord_transformation()
    # rotation,translation=transformer(coord1,coord2,path_all)
    rotation, translation = transformer(coord3, coord2, path_all)
    # rotation,translation=transformer('Coord_Infrastructure_lidar' ,'Coord_world',path_all)
    rotation1, translation1 = transformer(coord2, coord3, path_all)
    point = transformer.point_transformation([1, 1, 1], rotation, translation)
    point2 = transformer.point_transformation(point, rotation1, translation1)
    rotation, translation = transformer(coord1, coord3, path_all)

# DATA="/data/hdd01/aidata2/users/ad_sharing/datasets/v2x/release_data/DAIR-V2X/cooperative-vehicle-infrastructure/infrastructure-side/"
#DATA="/data/hdd01/aidata2/users/ad_sharing/datasets/v2x/release_data/DAIR-V2X-Train-Val/DAIR-V2X-Examples/cooperative-vehicle-infrastructure/infrastructure-side/"
DATA="/home/DAIR/maoz/Datasets/dair-v2x/cooperative-vehicle-infrastructure-example/"
OUTPUT="../cache/inf_single"

MODEL_PATH="/home/DAIR/maoz/dev/dair-v2x/checkpoints/joint-model-from-taohua-mono-car-1225"
MODEL_NAME="i"
CONFIG_NAME="road_raw.py"

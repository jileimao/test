...
def inference_detector_fature_fusion(model, veh_bin, inf_bin,rotation,translation,vic_frame):
...
class FeatureFlow(BaseModel):
    ...
    def __init__(self, args,pipe):
        ...
        self.args = args
        self.pipe=pipe
        self.args.veh_config_path=osp.abspath('../../')+self.args.veh_config_path
        self.args.veh_model_path=osp.abspath('../../')+self.args.veh_model_path
    ...
    def forward(self, vic_frame, filt, prev_inf_frame_func=None, *args):
        ...
        result,_ = inference_detector_fature_fusion(self.model,tmp_veh,tmp_inf,rotation,translation,vic_frame)
